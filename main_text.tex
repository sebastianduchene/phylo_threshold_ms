...
\section{Discussion}
Our mean rate estimates over all lineages are somewhat lower than earlier estimates \citep{duchene2020temporal}, which is consistent with the notion that the virus has had time to evolve and remove transient deleterious mutations since its emergence \citep{ghafari2021purifying}. However, the molecular evolutionary rate of SARS-CoV-2 displays substantial variation among lineages, a pattern that has been apparent since early phylogenetic analyses of the virus \citep{duchene2020temporal}. Evolutionary rate variation is 

\section{Materials and methods}
safdsf

\subsection{Data set construction}
verify convergence of independent chains and we ensured that the effective sample size of all parameters was at least 200.
