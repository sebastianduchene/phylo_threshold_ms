...
\subsection{Empirical analyses of Hepatitis B virus ancient and modern genomes}
...
\begin{figure}[H]
    \begin{center}
        ...
        \caption{However, in these analyses we deliberate use misleading priors on two key parameters, with a exponential distribution with mean 5,000 for the coalescent population size (true value=5,000), and a $\Gamma(shape=1.5, rate=10^{6})$ with mean=$1.5\times10^{-6}$ (true value=$1.5\times10^{-5}$).}
        \label{figure:Fig6}
    \end{center}
    %		\centering
\end{figure}
